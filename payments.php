	...
	<div class="main-container">
		...
		<!--menu-->
			<div class="menu">
				...
				<ul>
					...
					<li onclick="update_payment_modal();" ><i style="color:goldenrod;" class="fas fa-edit"></i> <section>Edit</section></li>
					<li onclick="delete_payment();" ><i style="color:red;" class="fas fa-minus"></i> <section>Delete</section></li>
		...
		<!--nav-bar-->
			<div class="nav-bar">
				...
				<i onclick="loader_show();window.location='payments.php';" class="fas fa-receipt active"></i>
				...
				<section onclick="loader_show();window.location='payments.php';" class="active">Payments</section>
